    ...
    return (
      <div className="App">
        <label>
          {' '}
          Username:
         <CreateComponent type={'input'} eltid='usrname' eventHandler={handleUsernameChange} text={'username'}/> 
        </label>
        <label>
          {' '}
          Password:
        <CreateComponent type={'input'} eltid='passwd' eventHandler={handlePasswordChange} text={'password'}/> 
        </label>
